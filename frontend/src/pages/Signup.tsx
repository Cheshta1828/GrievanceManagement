...
const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // console.log("Mocking registration for UI testing...");
    ...
    try {
      ...
      // Helper to check message type safely
      ...
      if (msg.includes('user registered successfully') || !formError) {
        setFailedAttempts(0);
        setSuccessData({
          message: backendMessage || "Registration successful!",
          username: name,
          email,
          role: 'user',
        });
      ...
      setFormError('A network or server error occurred. Please ensure the backend is running.');
    }
  };
